#normal word2vec not apply date and code version
...
class WVCY():
    def __init__(self,n = None):
        ...
        self.idx2word = [tk for tk,_ in self.counter.items()]
...
def main(batch_size,n_workers,lr,total_epoch,n):
    ...
    while epoch - best_flag < 10 and epoch < total_epoch:
        epoch += 1
        loss_collector = []
    ...
    pbar.close()
    return best_model.embed_v.weight.data,word2idx
...
if __name__ == "__main__":
    ...
    wv = wv.cpu().numpy()
    joblib.dump(wv,"/root/autodl-tmp/PAPER/DATA/lexicon/wordvec/wordvec_org.pkl")
    joblib.dump(word2idx,"/root/autodl-tmp/PAPER/DATA/lexicon/wordvec/word2idx_org.pkl")
    os.system("shutdown")
